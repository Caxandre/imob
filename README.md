...
Backend de uma plataforma SaaS imobiliária multi-tenant. Este repositório contém **apenas o
backend**; o frontend vive em um projeto separado (sem monorepo).
...
- **Backend separado do frontend**, sem monorepo.
