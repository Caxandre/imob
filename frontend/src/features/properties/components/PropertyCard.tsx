 ...
 * "0" (section 28), and `area_m2` only renders when present (section 29). Navigates to the
 * detail page via React Router's `Link` (Prompt 038, section 4) — never `window.location`.
 */
